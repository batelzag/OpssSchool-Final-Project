#!/usr/bin/env bash
# This script installs and configures the intance as a consul-agent and also installs and configures ansible
...
# In order to make sure Jenkins server is fully up, suspending the run of the playbook for 90 seconds
sleep 30
